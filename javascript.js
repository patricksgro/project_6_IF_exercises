...
/* for(let ciclo = 0; ciclo < 15; ciclo ++) {
    if (ciclo % 2 === 0) {
        console.log(`${ciclo} è un numero pari`)
    } else {
        console.log(`${ciclo} è un numero dispari`)
    }
} */
...
if (num1 === 8 || num2 === 8) {   
    console.log("verifica effettuata, è stato inserito almeno un 8")
} else if(num1 + num2 === 8) {
    console.log("L'addizione da come risultato 8")
} else if(num1 - num2 === 8) {
